...
const TWO_V2_COMBOS = [
  { id:"hog_support", name:"Hog + Support", archetype:"Hog Cycle + Support", tier:"S", synergyScore:95, p1Role:"Win condition", p2Role:"Defense & spells",
    p1Cards:["Hog Rider","Ice Spirit","Skeletons","The Log","Musketeer","Ice Golem","Fireball","Barbarian Barrel"],
    p2Cards:["Cannon","Firecracker","Earthquake","Knight","Archers","Zap","Bats","Royal Giant"],
    description:"P1 pushes Hog while P2 covers with buildings and spells.", tip:"Time Hog pushes when P2 drops Earthquake or Cannon for max pressure." },
  { id:"loon_freeze", name:"Balloon + Freeze", archetype:"LavaLoon + Control", tier:"S", synergyScore:92, p1Role:"Air attacker", p2Role:"Freeze & air support",
    p1Cards:["Balloon","Lava Hound","Lumberjack","Mega Minion","Minions","Zap","Lightning","Tombstone"],
    p2Cards:["Freeze","Minions","Tombstone","Zap","Baby Dragon","Inferno Dragon","Magic Archer","Archers"],
    description:"Lava Hound tanks while P2 Freezes tower defenders for Balloon.", tip:"P2 waits for tower to target Lava Hound, then Freeze for a free Balloon hit." },
  { id:"golem_cycle", name:"Golem + Cycle", archetype:"Golem Beatdown + Cycle", tier:"S", synergyScore:90, p1Role:"Beatdown tank", p2Role:"Cheap cycle support",
    p1Cards:["Golem","Night Witch","Baby Dragon","Lightning","Tombstone","Mega Minion","Zap","Lumberjack"],
    p2Cards:["Skeletons","Ice Spirit","Zap","Mega Minion","Archers","Bats","Musketeer","Fireball"],
    description:"P1 builds Golem beatdown, P2 cycles cheap support behind it.", tip:"P2 Zap/Skeletons clear goblin distractions while Golem tanks tower shots." },
  { id:"log_bait", name:"Log Bait + Bait Chain", archetype:"Double Bait", tier:"A+", synergyScore:85, p1Role:"Log Bait win con", p2Role:"Spell bait extension",
    p1Cards:["Goblin Barrel","Princess","Goblin Gang","Rocket","Inferno Tower","Knight","The Log","Barbarian Barrel"],
    p2Cards:["Skeleton Army","Minions","Knight","Fireball","Goblin Gang","Dart Goblin","Bats","Zap"],
    description:"Chain bait — drain all opponent spells across both players then barrel wins.", tip:"P2 deploys Skeleton Army to bait Log/Zap so P1's Goblin Barrel hits free." },
  { id:"miner_poison", name:"Miner + Poison Cycle", archetype:"Miner Cycle + Support", tier:"A+", synergyScore:85, p1Role:"Miner chip", p2Role:"Poison chip",
    p1Cards:["Miner","Wall Breakers","Bats","Goblin Gang","Night Witch","Magic Archer","Zap","Skeleton Army"],
    p2Cards:["Poison","Musketeer","Zap","Ice Golem","Skeletons","Electro Wizard","Fireball","Bats"],
    description:"Alternate Miner and Poison every cycle for relentless tower chip damage.", tip:"Never let the tower breathe — Miner hits while Poison cooldown finishes." },
  { id:"graveyard_poison", name:"Graveyard + Poison", archetype:"Graveyard Control", tier:"A+", synergyScore:84, p1Role:"Win condition", p2Role:"Spell support",
    p1Cards:["Graveyard","Ice Golem","Tombstone","Knight","Archers","Bats","Electro Wizard","Zap"],
    p2Cards:["Poison","Minions","Archers","Barbarian Barrel","Ice Wizard","Tornado","Musketeer","Zap"],
    description:"P1 deploys Graveyard while P2's Poison zones out tower defenses.", tip:"P2 Poisons the moment P1 places Graveyard so skeletons get uncontested damage." },
  { id:"pekka_bridge", name:"PEKKA + Bridge Spam", archetype:"Double Bridge Spam", tier:"A+", synergyScore:82, p1Role:"Heavy hitter", p2Role:"Flanker & spam",
    p1Cards:["P.E.K.K.A","Bandit","Battle Ram","Poison","Magic Archer","Electro Wizard","Zap","Royal Ghost"],
    p2Cards:["Royal Ghost","Magic Archer","Electro Wizard","Zap","Bandit","Dark Prince","Goblin Gang","Battle Ram"],
    description:"Both players spam bridge units simultaneously for overwhelming pushes.", tip:"Never push alone — wait for P2 to commit before bridging your PEKKA." },
  { id:"giant_beatdown", name:"Giant + Beatdown", archetype:"Giant Beatdown", tier:"A", synergyScore:78, p1Role:"Front tank", p2Role:"Damage dealers",
    p1Cards:["Giant","Musketeer","Zap","Cannon","Electro Wizard","Minions","Fireball","Skeleton Army"],
    p2Cards:["Witch","Baby Dragon","Fireball","Mega Minion","Lightning","Tombstone","Archers","Zap"],
    description:"P1 deploys Giant as tank, P2 stacks damage units behind it.", tip:"Drop Giant at bridge, then P2 immediately stacks troops behind for full push." },
  { id:"xbow_mortar", name:"X-Bow + Mortar Siege", archetype:"Double Siege", tier:"A", synergyScore:76, p1Role:"X-Bow siege", p2Role:"Mortar siege",
    p1Cards:["X-Bow","Tesla","Ice Spirit","Skeletons","The Log","Archers","Ice Golem","Earthquake"],
    p2Cards:["Mortar","Ice Spirit","Skeletons","The Log","Goblin Gang","Knight","Fireball","Bats"],
    description:"Dual siege forces opponent to split defense across both structures.", tip:"Deploy X-Bow on one side and Mortar opposite — opponent can't cover both." },
  { id:"double_rush", name:"Double Lane Rush", archetype:"Full Rush", tier:"B+", synergyScore:68, p1Role:"Left lane", p2Role:"Right lane",
    p1Cards:["Barbarian Barrel","Goblin Gang","Knight","Archers","Ice Spirit","Zap","Hog Rider","Musketeer"],
    p2Cards:["Minion Horde","Goblin Gang","Ice Spirit","Skeletons","Balloon","Mega Minion","Zap","Lumberjack"],
    description:"Split lane rush — flood both lanes simultaneously to overwhelm defenses.", tip:"Commit to different lanes so opponent must defend two towers at once." },
];
